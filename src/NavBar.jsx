    ...
    <nav class="bg-transparent border-gray-200 dark:bg-gray-900 dark:border-gray-700">
      <div class="w-full flex flex-row items-center justify-between mx-auto p-4">
        <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
          <img src="src/images/Logo.png" class="h-10 w-10" alt="Logo" />
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-multi-level">
          <ul class="flex flex-col font-medium p-2 md:p-0 mt-2 bg-transparent md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <a
                href="/"
